...
export interface ApiAttractionAttraction extends Schema.CollectionType {
  ...
  attributes: {
    ...
    lat: Attribute.Float;
    lng: Attribute.Float;
    hotspot: Attribute.Relation<
      'api::attraction.attraction',
      'manyToOne',
      'api::hotspot.hotspot'
    >;
    title: Attribute.String;
    more: Attribute.Boolean & Attribute.Required & Attribute.DefaultTo<false>;
...
export interface ApiCountryinfoCountryinfo extends Schema.CollectionType {
  collectionName: 'countryinfos';
  info: {
    singularName: 'countryinfo';
    pluralName: 'countryinfos';
  ...
  attributes: {
    name: Attribute.String;
    description: Attribute.Text;
    info: Attribute.Component<'travel-info.info', true>;
    image: Attribute.Media;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
    publishedAt: Attribute.DateTime;
...
export interface ApiHotspotHotspot extends Schema.CollectionType {
  ...
  attributes: {
    ...
    attractions: Attribute.Relation<
      ...
      'api::attraction.attraction'
    >;
    type: Attribute.Enumeration<['city', 'region']> & Attribute.Required;
    top_hotspot: Attribute.Relation<
      'api::hotspot.hotspot',
      'manyToOne',
...
export interface ApiTopHotspotTopHotspot extends Schema.CollectionType {
  collectionName: 'top_hotspots';
  info: {
    singularName: 'top-hotspot';
    pluralName: 'top-hotspots';
    displayName: 'topHotspot';
    description: '';
  };
  options: {
    draftAndPublish: true;
